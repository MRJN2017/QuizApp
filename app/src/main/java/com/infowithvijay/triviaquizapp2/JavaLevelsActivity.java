        ...
        if (CategoryValue.equals("Tpu")){
            ...
            switch (view.getId()){
                ...
                case R.id.Level1:
                    ...
                    intentJavaLevel1.putExtra("Category",TriviaQuestion.CATEGORY_TPU);
                ...
                case R.id.Level2:
                    ...
                    intentJavaLevel2.putExtra("Category",TriviaQuestion.CATEGORY_TPU);
                ...
                case R.id.Level3:
                    ...
                    intentJavaLevel3.putExtra("Category",TriviaQuestion.CATEGORY_TPU);
                ...
                case R.id.Level4:
                    ...
                    intentJavaLevel4.putExtra("Category",TriviaQuestion.CATEGORY_TPU);
