...
public class PlayScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btPlayQuiz,btSettings,btStudy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btStudy = findViewById(R.id.bt_Information);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.bt_Information:
                Intent studyIntent = new Intent(PlayScreen.this,SelectStudyActivity.class);
    ...
    public void onBackPressed() {
        ...
        if (backPressedTime + 2000 > System.currentTimeMillis()){
            ...
            new AlertDialog.Builder(this)
                    .setTitle("Apakah Anda Ingin Meninggalkan Permainan")
